...
function Work({
  ...
  return (
    <article className="pt-8 border-b-2 pb-5 border-opacity-20 dark:border-opacity-20 border-gray-300 dark:border-gray-700 ">
      <div className="flex justify-between items-center mb-2 ">
        {position ? (
          <>
            <h1 className="text-black text-xl lg:text-2xl font-semibold">{position}</h1>
            <div className="btn bg-green-500 text-white text-xs lg:text-sm inline-block rounded-full px-4 py-1">
              {type}
            </div>
          </>
        ) : (
          <h1 className="text-black text-xl lg:text-2xl font-semibold">{stream}</h1>
        )}
      </div>
      <div className="flex justify-between">
        <div className="flex flex-col md:flex-row items-start md:items-center mb-1">
          <div className="flex items-center mb-1 md:mb-0 pr-5">
            <svg
              className="dark:fill-yellow-300 fill-gray-700"
              width="16"
              height="12"
              viewBox="0 0 16 12"
              fill="none"
            ...
            <p className="text-lime-200 text-sm md:text-base font-light pl-1">
        ...
        <p className="text-lime-200 text-sm md:text-base font-light pl-1 min-w-fit">{duration}</p>
      </div>
    </article>
  );
}
