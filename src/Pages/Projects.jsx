...
function Projects() {
  return (
    <main
      className="relative bg-cover bg-center bg-no-repeat w-full min-h-screen flex flex-col items-center pt-16 py-10 px-4 sm:px-8"
      style={{ backgroundImage: "url('/path/to/your/background.jpg')" }}
    >
      <div className="absolute inset-0 bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 opacity-75"></div>
      <div className="relative z-10 w-full max-w-6xl text-gray-900">
        <section className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-extrabold mb-6 leading-tight text-neutral-200">Projects</h1>
