...
function Technologies() {
  ...
  const tools = [
    ...
    { src: adobe, title: "Adobe", description: "Tools for video, graphic, and Photoshop design." },
  ];

  return (
    <main
      className="relative bg-cover bg-center bg-no-repeat w-full min-h-screen flex flex-col items-center py-10 px-4 sm:px-8"
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-6xl text-neutral-200">
        <section className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-extrabold mb-4 leading-tight text-neutral-200">
            Tech Stack
          </h1>
          <p className="text-lg sm:text-xl mb-8 text-neutral-200">
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-12 opacity-75">
          {techStack.map((tech, index) => (
            ...
            >
              ...
              />
              <h2 className="text-xl font-semibold mb-2 text-gray-800">{tech.title}</h2>
        ...
        <section className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-extrabold mb-4 leading-tight text-purple-950">
            Tools
          </h1>
        </section>
